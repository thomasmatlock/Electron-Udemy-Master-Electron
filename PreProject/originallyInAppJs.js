...
// console.log('hello from app.js'); // this is integrated into the browser window via html doc, and runs this JS there in the browser. I think NodeIntegration is important here
